...
export default function GuideScreen() {
  ...
  const faqs = [
    ...
    { title: "Що таке Волатильність?", content: "Волатильність — це статистична міра розкиду доходності для даного цінного паперу. У RiskMate ми використовуємо історичну волатильність для налаштування симуляцій Монте-Карло." },
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Text style={styles.subtitle}>Фінанси не повинні бути складними. Ми пояснюємо основні терміни RiskMate.</Text>
