    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Text style={styles.subtitle}>
          RiskMate використовує передові математичні моделі та алгоритми штучного інтелекту.
        </Text>
        ...
        <View style={styles.sectionCard}>
          ...
          <Text style={styles.sectionText}>
            Клас обчислювальних алгоритмів, що спираються на багаторазове випадкове моделювання. RiskMate генерує тисячі можливих траєкторій ціни активу, що дозволяє побачити не лише середній результат, але й спектр найгірших сценаріїв.
          </Text>
        </View>
