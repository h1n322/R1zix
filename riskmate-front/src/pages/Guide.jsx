...
const Guide = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      content: "Волатильність — це статистична міра розкиду доходності для даного цінного паперу або ринкового індексу. У більшості випадків чим вища волатильність, тим ризикованіший актив. У RiskMate ми використовуємо історичну волатильність для налаштування симуляцій Монте-Карло."
    },
    {
    ...
    },
    {
      ...
      content: "Це теоретична ставка дохідності інвестицій з нульовим ризиком (зазвичай це дохідність державних облігацій, наприклад, США). Вона використовується в RiskMate для розрахунку коефіцієнта Шарпа, щоб зрозуміти, чи виправданий ризик порівняно з безпечним зберіганням грошей."
    },
    {
