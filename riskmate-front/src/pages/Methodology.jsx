    ...
    <PageTransition>
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>5. Типи алгоритмів симуляції</h2>
            <p className={styles.text}>
              RiskMate дозволяє обрати математичну модель, яка найкраще відповідає поведінці вашого активу. Доступні два основні підходи:
            </p>
            <ul className={styles.list}>
              <li className={styles.listItem}>
                <span className={styles.boldText}>Classic GBM Monte Carlo</span> — класична модель, яка припускає, що ціни змінюються плавно і неперервно (як броунівський рух частинок). Найкраще підходить для високоліквідних, стабільних акцій (наприклад, Apple чи Microsoft у спокійні періоди) або широких ринкових індексів (S&P 500).
              </li>
              <li className={styles.listItem}>
                <span className={styles.boldText}>Merton Jump Diffusion</span> — вдосконалена модель, розроблена Робертом Мертоном. Вона враховує те, що реальні ринки часто відчувають раптові "стрибки" (jumps) через неочікувані новини, звіти про прибутки або економічні кризи. Цей алгоритм ідеальний для волатильних активів, криптовалют або акцій компаній під час сезону звітностей, оскільки він моделює як плавні коливання, так і раптові гепи (розриви) в ціні.
              </li>
            </ul>
          </section>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.text}>
              <span className={styles.boldText}>Хеджування</span> — це фінансова стратегія "страхування" ваших інвестицій від падіння ціни. У RiskMate ми автоматично розраховуємо стратегію захисту за допомогою Put-опціонів. Якщо ціна активу падає, ваш опціон зростає в ціні, компенсуючи збитки.
            </p>
            <p className={styles.text}>
              Для точного розрахунку вартості такого страхування (премії опціону) RiskMate використовує Нобелівську <span className={styles.boldText}>модель Блека-Шоулза (Black-Scholes)</span>. 
            </p>
            ...
            <ul className={styles.list}>
              ...
              <li className={styles.listItem}><b>Страйк-ціна (X):</b> ціна, по якій ви "застрахували" свій актив (RiskMate автоматично встановлює її на рівні VaR, щоб захистити вас від критичних збитків).</li>
